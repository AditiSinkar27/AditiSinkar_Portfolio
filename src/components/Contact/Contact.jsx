    ...
    >
      ...
      <div className="text-center text-white space-y-4 text-lg">
        <p>
          📧 Email:{" "}
          <a
            href="mailto:aditisinkar27@gmail.com"
            className="text-purple-400 hover:underline"
          >
            aditisinkar27@gmail.com
          </a>
        </p>
        <p>
          📞 Phone:{" "}
          <a
            href="tel:+918830644998"
            className="text-purple-400 hover:underline"
          >
            +91 8830644998
          </a>
      ...
      <div className="flex justify-center gap-6 mt-8 text-3xl text-white">
        <a
          href="https://www.linkedin.com/in/aditi-sinkar/"
          target="_blank"
        ...
        <a
          href="https://github.com/AditiSinkar27"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-purple-400"
        >
